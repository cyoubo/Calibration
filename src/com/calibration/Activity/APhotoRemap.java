...
public class APhotoRemap extends Activity implements Initialization
{
	...
	OnClickListener imageClickListener=new OnClickListener()
	{
		...
		public void onClick(View v)
		{
			...
			dialog.SetAdapter(adapter, new DialogInterface.OnClickListener()
			{
				...
				{
					//获取选定的标定结果
					beansHelper =new CalibrationResultBeansHelper(adapter.getClickedItem(which));
					//显示标定结果名称
	...
	private void PrepareAdapter()
	{
		...
		adapter=new CalibrationResultAdapter(this, CalibrationResultBeansHelper.queryAll(context));
	 ...
	 * **/
	private class RemapAsynTask extends AsyncTask<CalibrationResultBeansHelper, String, Integer>
	{
		/**待重采样的图像路径*/
		...
		@Override
		protected Integer doInBackground(CalibrationResultBeansHelper... params)
		{
